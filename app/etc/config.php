...
return [
    'modules' => [
        ...
        'Mageplaza_Sitemap' => 1,
        'Mageplaza_Smtp' => 1,
        'Mobikasa_CollectionOption' => 1,
        'Mobikasa_Customer' => 1,
        'Mobikasa_Days' => 1,
        'Mobikasa_Designers' => 1,
        'Mobikasa_Filters' => 1,
        'Mobikasa_GalleryImageOne' => 1,
        'Mobikasa_Months' => 1,
        'Mobikasa_Newsletters' => 1,
        'Mobikasa_Phones' => 1,
        'Mobikasa_Variants' => 1,
        'Mobikasa_Wishlist' => 1,
        'MyModule_CheckoutSummary' => 1,
        'Navin_MinicartOpen' => 1,
