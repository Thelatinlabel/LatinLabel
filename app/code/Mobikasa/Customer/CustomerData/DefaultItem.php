...
namespace Mobikasa\Customer\CustomerData;
...

{
    ...
    protected function doGetItemData()
    {
        ...
        $brandname = $this->item->getProduct()->getResource()->getAttribute('mgs_brand')->getFrontend()->getValue($this->item->getProduct());
        ...
        return [
            ...
            'product_name' => '<div class="_brands">'.$brandname.'</div>'.$productName,
