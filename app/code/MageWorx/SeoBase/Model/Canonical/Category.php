...
class Category extends \MageWorx\SeoBase\Model\Canonical
{
    ...
    public function getCanonicalUrl()
    {
        ...
        $this->canonicalUrl = $this->getCustomCanonicalUrl($category);
        ...
        if ($crossDomainUrl) {
            $this->canonicalUrl = $this->trailingSlash($crossDomainUrl);
        ...
        if ($this->helperLayer->getCurrentLayeredFilters()) {
            ...
            if (!$this->isIncludeLNFiltersToCanonicalUrl()) {
                $this->canonicalUrl = $this->trailingSlash($category->getUrl());
        ...
        $this->canonicalUrl = $this->helperUrl->escapeUrl($url);
