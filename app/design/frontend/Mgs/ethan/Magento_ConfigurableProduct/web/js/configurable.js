...
define([
    ...
    $.widget('mage.configurable', {
        ...
        _calculatePrice: function (config) {
            jQuery('#mgs-instant-autocomplete-wrapper #product-wrapper li').remove();
            jQuery('#mgs-instant-autocomplete-wrapper [role="listbox"] li').remove();
            console.log($(this.options.priceHolderSelector).priceBox());
            console.log($(this.options.priceHolderSelector).priceBox().priceBox('option'));
            console.log($(this.options.priceHolderSelector).priceBox('option'));
            var displayPrices = $(this.options.priceHolderSelector).priceBox().priceBox('option').prices,
