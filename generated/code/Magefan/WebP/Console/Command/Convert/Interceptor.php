<?php
namespace Magefan\WebP\Console\Command\Convert;

/**
 * Interceptor class for @see \Magefan\WebP\Console\Command\Convert
 */
class Interceptor extends \Magefan\WebP\Console\Command\Convert implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magefan\WebP\Model\Filesystem\PubFolder $pubFolder, \Magento\Framework\Escaper $escaper, \Magento\Framework\App\State $state, \Magefan\WebP\Model\Config $config, $name = null)
    {
        $this->___init();
        parent::__construct($pubFolder, $escaper, $state, $config, $name);
    }
