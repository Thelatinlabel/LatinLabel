...
class Interceptor extends \Magento\Catalog\Block\Adminhtml\Product\Helper\Form\Gallery implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getImageValue');
        if (!$pluginInfo) {
            return parent::getImageValue($type);
        } else {
            return $this->___callPlugins('getImageValue', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentHtml');
        if (!$pluginInfo) {
            return parent::getContentHtml();
        } else {
            return $this->___callPlugins('getContentHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getFieldNameSuffix');
        if (!$pluginInfo) {
            return parent::getFieldNameSuffix();
        } else {
            return $this->___callPlugins('getFieldNameSuffix', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataScopeHtmlId');
        if (!$pluginInfo) {
            return parent::getDataScopeHtmlId();
        } else {
            return $this->___callPlugins('getDataScopeHtmlId', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'canDisplayUseDefault');
        if (!$pluginInfo) {
            return parent::canDisplayUseDefault($attribute);
        } else {
            return $this->___callPlugins('canDisplayUseDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'usedDefault');
        if (!$pluginInfo) {
            return parent::usedDefault($attribute);
        } else {
            return $this->___callPlugins('usedDefault', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDataObject');
        if (!$pluginInfo) {
            return parent::getDataObject();
        } else {
            return $this->___callPlugins('getDataObject', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAttributeFieldName');
        if (!$pluginInfo) {
            return parent::getAttributeFieldName($attribute);
        } else {
            return $this->___callPlugins('getAttributeFieldName', func_get_args(), $pluginInfo);
        }
    }
