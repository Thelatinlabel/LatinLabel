...
class Interceptor extends \Magento\Customer\Block\Form\Register implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function isNewsletterEnabled()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('isNewsletterEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function restoreSessionData(\Magento\Customer\Model\Metadata\Form $form, $scope = null)
    {
        ...
        if (!$pluginInfo) {
            return parent::restoreSessionData($form, $scope);
        } else {
            return $this->___callPlugins('restoreSessionData', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMinimumPasswordLength()
    {
        ...
        if (!$pluginInfo) {
            return parent::getMinimumPasswordLength();
        } else {
            return $this->___callPlugins('getMinimumPasswordLength', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getRequiredCharacterClassesNumber()
    {
        ...
        if (!$pluginInfo) {
            return parent::getRequiredCharacterClassesNumber();
        } else {
            return $this->___callPlugins('getRequiredCharacterClassesNumber', func_get_args(), $pluginInfo);
        }
    }
