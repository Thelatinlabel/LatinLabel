<?php
namespace MGS\Promobanners\Block\Widget\Banner;

/**
 * Interceptor class for @see \MGS\Promobanners\Block\Widget\Banner
 */
class Interceptor extends \MGS\Promobanners\Block\Widget\Banner implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannerById');
        if (!$pluginInfo) {
            return parent::getBannerById($id);
        } else {
            return $this->___callPlugins('getBannerById', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannerImageUrl');
        if (!$pluginInfo) {
            return parent::getBannerImageUrl($banner);
        } else {
            return $this->___callPlugins('getBannerImageUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCustomClass($banner)
    {
        ...
        if (!$pluginInfo) {
            return parent::getCustomClass($banner);
        } else {
