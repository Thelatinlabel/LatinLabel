<?php
namespace MGS\Mpanel\Block\Panel\HomeContent;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Panel\HomeContent
 */
class Interceptor extends \MGS\Mpanel\Block\Panel\HomeContent implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\ObjectManagerInterface $objectManager, \MGS\Mpanel\Helper\Data $helper, \Magento\Customer\Model\Session $customerSession, \Magento\Cms\Model\Template\FilterProvider $filterProvider, \MGS\Mpanel\Model\ResourceModel\Section\CollectionFactory $sectionFactory, \Magento\Catalog\Model\ResourceModel\Product\Attribute\CollectionFactory $attributeCollection, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $objectManager, $helper, $customerSession, $filterProvider, $sectionFactory, $attributeCollection, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSectionSetting');
        if (!$pluginInfo) {
            return parent::getSectionSetting($section, $canUsePanel);
        } else {
            return $this->___callPlugins('getSectionSetting', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockCols');
        if (!$pluginInfo) {
            return parent::getBlockCols();
        } else {
            return $this->___callPlugins('getBlockCols', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEditPanel');
        if (!$pluginInfo) {
            return parent::getEditPanel();
        } else {
            return $this->___callPlugins('getEditPanel', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlockClass');
        if (!$pluginInfo) {
            return parent::getBlockClass($section, $col, $arrClass, $key, $canUsePanel);
        } else {
            return $this->___callPlugins('getBlockClass', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'wasSave');
        if (!$pluginInfo) {
            return parent::wasSave();
        } else {
            return $this->___callPlugins('wasSave', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'unsetSaveSection');
        if (!$pluginInfo) {
            return parent::unsetSaveSection();
        } else {
            return $this->___callPlugins('unsetSaveSection', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAvailableAttributes');
        if (!$pluginInfo) {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMegamenus');
        if (!$pluginInfo) {
            return parent::getMegamenus();
        } else {
            return $this->___callPlugins('getMegamenus', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlogCategories');
        if (!$pluginInfo) {
            return parent::getBlogCategories();
        } else {
            return $this->___callPlugins('getBlogCategories', func_get_args(), $pluginInfo);
        }
    }
