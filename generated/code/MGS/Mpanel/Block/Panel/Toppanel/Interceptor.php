<?php
namespace MGS\Mpanel\Block\Panel\Toppanel;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Panel\Toppanel
 */
class Interceptor extends \MGS\Mpanel\Block\Panel\Toppanel implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \MGS\Mpanel\Helper\Data $helper, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPageLayoutConfig');
        if (!$pluginInfo) {
            return parent::getPageLayoutConfig();
        } else {
            return $this->___callPlugins('getPageLayoutConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPerrowConfig');
        if (!$pluginInfo) {
            return parent::getPerrowConfig();
        } else {
            return $this->___callPlugins('getPerrowConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRatioConfig');
        if (!$pluginInfo) {
            return parent::getRatioConfig();
        } else {
            return $this->___callPlugins('getRatioConfig', func_get_args(), $pluginInfo);
        }
    }
