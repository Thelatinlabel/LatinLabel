<?php
namespace MGS\Mpanel\Block\Panel\Block;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Panel\Block
 */
class Interceptor extends \MGS\Mpanel\Block\Panel\Block implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBlocks');
        if (!$pluginInfo) {
            return parent::getBlocks();
        } else {
            return $this->___callPlugins('getBlocks', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getBlockClass($block, $setting, $canUsePanel)
    {
        ...
        if (!$pluginInfo) {
            return parent::getBlockClass($block, $setting, $canUsePanel);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getEditChildHtml');
        if (!$pluginInfo) {
            return parent::getEditChildHtml($block, $child);
        } else {
            return $this->___callPlugins('getEditChildHtml', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getContentOfBlock');
        if (!$pluginInfo) {
            return parent::getContentOfBlock($block);
        } else {
            return $this->___callPlugins('getContentOfBlock', func_get_args(), $pluginInfo);
        }
    }
