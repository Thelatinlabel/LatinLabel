...
class Interceptor extends \MGS\Mpanel\Block\Catalog\Product\View\Gallery implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getThemeHelper');
        if (!$pluginInfo) {
            return parent::getThemeHelper();
        } else {
            return $this->___callPlugins('getThemeHelper', func_get_args(), $pluginInfo);
        }
    }
