<?php
namespace MGS\Mpanel\Block\Widget\OwlCarousel;

/**
 * Interceptor class for @see \MGS\Mpanel\Block\Widget\OwlCarousel
 */
class Interceptor extends \MGS\Mpanel\Block\Widget\OwlCarousel implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Filesystem\Driver\File $file, array $data = [])
    {
        $this->___init();
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAllImages');
        if (!$pluginInfo) {
            return parent::getAllImages();
        } else {
            return $this->___callPlugins('getAllImages', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBannerLinks');
        if (!$pluginInfo) {
            return parent::getBannerLinks();
        } else {
            return $this->___callPlugins('getBannerLinks', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAnimateSlider');
        if (!$pluginInfo) {
            return parent::getAnimateSlider();
        } else {
            return $this->___callPlugins('getAnimateSlider', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAutoSpeed');
        if (!$pluginInfo) {
            return parent::getAutoSpeed();
        } else {
            return $this->___callPlugins('getAutoSpeed', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAutoPlay');
        if (!$pluginInfo) {
            return parent::getAutoPlay();
        } else {
            return $this->___callPlugins('getAutoPlay', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getControlNav');
        if (!$pluginInfo) {
            return parent::getControlNav();
        } else {
            return $this->___callPlugins('getControlNav', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getControlDots');
        if (!$pluginInfo) {
            return parent::getControlDots();
        } else {
            return $this->___callPlugins('getControlDots', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRightToLeft');
        if (!$pluginInfo) {
            return parent::getRightToLeft();
        } else {
            return $this->___callPlugins('getRightToLeft', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoop');
        if (!$pluginInfo) {
            return parent::getLoop();
        } else {
            return $this->___callPlugins('getLoop', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'checkFull');
        if (!$pluginInfo) {
            return parent::checkFull();
        } else {
            return $this->___callPlugins('checkFull', func_get_args(), $pluginInfo);
        }
    }
