...
class Interceptor extends \MGS\Mpanel\Block\Products\ProductItem implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLoadCategory');
        if (!$pluginInfo) {
            return parent::getLoadCategory($id);
        } else {
            return $this->___callPlugins('getLoadCategory', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoriesLink');
        if (!$pluginInfo) {
            return parent::getCategoriesLink($_product);
        } else {
            return $this->___callPlugins('getCategoriesLink', func_get_args(), $pluginInfo);
        }
    }
