...
/**
 * Interceptor class for @see \MGS\Mpanel\Model\Category
 */
class Interceptor extends \MGS\Mpanel\Model\Category implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getDisableFlat');
        if (!$pluginInfo) {
            return parent::getDisableFlat();
        } else {
            return $this->___callPlugins('getDisableFlat', func_get_args(), $pluginInfo);
        }
    }
