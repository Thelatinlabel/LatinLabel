<?php
namespace MGS\InstantSearch\Block\Search\Autocomplete;

/**
 * Interceptor class for @see \MGS\InstantSearch\Block\Search\Autocomplete
 */
class Interceptor extends \MGS\InstantSearch\Block\Search\Autocomplete implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Search\Model\QueryFactory $queryFactory, \MGS\InstantSearch\Helper\Data $inSearchHelper, array $layoutProcessors, \Magento\CatalogSearch\Helper\Data $catalogSearchData, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $queryFactory, $inSearchHelper, $layoutProcessors, $catalogSearchData, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSearchUrl');
        if (!$pluginInfo) {
            return parent::getSearchUrl();
        } else {
            return $this->___callPlugins('getSearchUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getTextNoRsult');
        if (!$pluginInfo) {
            return parent::getTextNoRsult();
        } else {
            return $this->___callPlugins('getTextNoRsult', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSearchQueryText()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getSearchQueryText', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getInstantSearchConfig');
        if (!$pluginInfo) {
            return parent::getInstantSearchConfig();
        } else {
            return $this->___callPlugins('getInstantSearchConfig', func_get_args(), $pluginInfo);
        }
    }
