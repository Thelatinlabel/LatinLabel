<?php
namespace MGS\Mmegamenu\Block\Mmegamenu;

/**
 * Interceptor class for @see \MGS\Mmegamenu\Block\Mmegamenu
 */
class Interceptor extends \MGS\Mmegamenu\Block\Mmegamenu implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Catalog\Model\CategoryFactory $categoryFactory, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Layer\Resolver $layerResolver, \Magento\Framework\App\Http\Context $httpContext, \Magento\Catalog\Helper\Category $catalogCategory, \Magento\Framework\Registry $registry, \Magento\Catalog\Model\Indexer\Category\Flat\State $flatState, \Magento\Framework\ObjectManagerInterface $objectManager, \Magento\Cms\Model\Template\FilterProvider $filterProvider, array $data = [])
    {
        $this->___init();
        parent::__construct($context, $categoryFactory, $productCollectionFactory, $layerResolver, $httpContext, $catalogCategory, $registry, $flatState, $objectManager, $filterProvider, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMegamenuItems');
        if (!$pluginInfo) {
            return parent::getMegamenuItems();
        } else {
            return $this->___callPlugins('getMegamenuItems', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCurrentCategoryKey()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCurrentCategoryKey();
        } else {
            return $this->___callPlugins('getCurrentCategoryKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getCurrentChildCategories()
    {
        ...
        if (!$pluginInfo) {
            return parent::getCurrentChildCategories();
        } else {
            return $this->___callPlugins('getCurrentChildCategories', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isCategoryActive($category)
    {
        ...
        if (!$pluginInfo) {
            return parent::isCategoryActive($category);
        } else {
            return $this->___callPlugins('isCategoryActive', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSubCategoryAccepp');
        if (!$pluginInfo) {
            return parent::getSubCategoryAccepp($categoryId, $item);
        } else {
            return $this->___callPlugins('getSubCategoryAccepp', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getMenuHtml($item)
    {
        ...
        if (!$pluginInfo) {
            return parent::getMenuHtml($item);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCategoryMenu');
        if (!$pluginInfo) {
            return parent::getCategoryMenu($item);
        } else {
            return $this->___callPlugins('getCategoryMenu', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'drawListSub');
        if (!$pluginInfo) {
            return parent::drawListSub($item, $catIds);
        } else {
            return $this->___callPlugins('drawListSub', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'drawList');
        if (!$pluginInfo) {
            return parent::drawList($category, $item, $level);
        } else {
            return $this->___callPlugins('drawList', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getStaticMenu');
        if (!$pluginInfo) {
            return parent::getStaticMenu($item);
        } else {
            return $this->___callPlugins('getStaticMenu', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getColumnByCol');
        if (!$pluginInfo) {
            return parent::getColumnByCol($col);
        } else {
            return $this->___callPlugins('getColumnByCol', func_get_args(), $pluginInfo);
        }
    }
