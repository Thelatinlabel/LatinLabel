<?php
namespace MGS\Brand\Block\Product\Brand;

/**
 * Interceptor class for @see \MGS\Brand\Block\Product\Brand
 */
class Interceptor extends \MGS\Brand\Block\Product\Brand implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\View\Element\Template\Context $context, \Magento\Framework\Registry $registry, \MGS\Brand\Helper\Data $brandHelper, \MGS\Brand\Model\Brand $brand, array $data = [])
    {
        $this->___init();
    ...
    public function getBrand()
    {
        ...
        if (!$pluginInfo) {
            ...
            return $this->___callPlugins('getBrand', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLayoutOptions');
        if (!$pluginInfo) {
            return parent::getLayoutOptions($withEmpty);
        } else {
            return $this->___callPlugins('getLayoutOptions', func_get_args(), $pluginInfo);
        }
    }
