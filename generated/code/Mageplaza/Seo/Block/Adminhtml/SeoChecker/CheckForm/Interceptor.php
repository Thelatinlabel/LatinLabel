...
class Interceptor extends \Mageplaza\Seo\Block\Adminhtml\SeoChecker\CheckForm implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLink');
        if (!$pluginInfo) {
            return parent::getLink();
        } else {
            return $this->___callPlugins('getLink', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'sitemap');
        if (!$pluginInfo) {
            return parent::sitemap();
        } else {
            return $this->___callPlugins('sitemap', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSeoData');
        if (!$pluginInfo) {
            return parent::getSeoData();
        } else {
            return $this->___callPlugins('getSeoData', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSeoToolUrl');
        if (!$pluginInfo) {
            return parent::getSeoToolUrl();
        } else {
            return $this->___callPlugins('getSeoToolUrl', func_get_args(), $pluginInfo);
        }
    }
