...
class Interceptor extends \Amazon\Core\Block\Config implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function isBadgeEnabled()
    {
        ...
        if (!$pluginInfo) {
            return parent::isBadgeEnabled();
        } else {
            return $this->___callPlugins('isBadgeEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isExtensionEnabled()
    {
        ...
        if (!$pluginInfo) {
            return parent::isExtensionEnabled();
        } else {
            return $this->___callPlugins('isExtensionEnabled', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function sanitizePaymentAction()
    {
        ...
        if (!$pluginInfo) {
            return parent::sanitizePaymentAction();
        } else {
            return $this->___callPlugins('sanitizePaymentAction', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function transformSandboxSimulationOptions()
    {
        ...
        if (!$pluginInfo) {
            return parent::transformSandboxSimulationOptions();
        } else {
            return $this->___callPlugins('transformSandboxSimulationOptions', func_get_args(), $pluginInfo);
        }
    }
