...
class Interceptor extends \Temando\Shipping\Block\Adminhtml\System\Config\Form\Field\Activation implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getRegisterAccountUrl');
        if (!$pluginInfo) {
            return parent::getRegisterAccountUrl();
        } else {
            return $this->___callPlugins('getRegisterAccountUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getAccountRedirectUrl');
        if (!$pluginInfo) {
            return parent::getAccountRedirectUrl();
        } else {
            return $this->___callPlugins('getAccountRedirectUrl', func_get_args(), $pluginInfo);
        }
    }
