...
class Interceptor extends \Temando\Shipping\Block\Adminhtml\System\Config\Form\Field\GettingStarted implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isMerchantRegistered');
        if (!$pluginInfo) {
            return parent::isMerchantRegistered();
        } else {
            return $this->___callPlugins('isMerchantRegistered', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getLocationsRedirectUrl');
        if (!$pluginInfo) {
            return parent::getLocationsRedirectUrl();
        } else {
            return $this->___callPlugins('getLocationsRedirectUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCarriersRedirectUrl');
        if (!$pluginInfo) {
            return parent::getCarriersRedirectUrl();
        } else {
            return $this->___callPlugins('getCarriersRedirectUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPackagesUrl');
        if (!$pluginInfo) {
            return parent::getPackagesUrl();
        } else {
            return $this->___callPlugins('getPackagesUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShippingPortalUrl');
        if (!$pluginInfo) {
            return parent::getShippingPortalUrl();
        } else {
            return $this->___callPlugins('getShippingPortalUrl', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getExperienceRedirectUrl');
        if (!$pluginInfo) {
            return parent::getExperienceRedirectUrl();
        } else {
            return $this->___callPlugins('getExperienceRedirectUrl', func_get_args(), $pluginInfo);
        }
    }
