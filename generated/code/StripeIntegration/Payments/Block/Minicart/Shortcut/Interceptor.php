...
class Interceptor extends \StripeIntegration\Payments\Block\Minicart\Shortcut implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsInCatalogProduct');
        if (!$pluginInfo) {
            return parent::setIsInCatalogProduct($isCatalog);
        } else {
            return $this->___callPlugins('setIsInCatalogProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'setIsShoppingCart');
        if (!$pluginInfo) {
            return parent::setIsShoppingCart($isShoppingCart);
        } else {
            return $this->___callPlugins('setIsShoppingCart', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function isEnabled($location)
    {
        ...
        if (!$pluginInfo) {
            return parent::isEnabled($location);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getPublishableKey');
        if (!$pluginInfo) {
            return parent::getPublishableKey();
        } else {
            return $this->___callPlugins('getPublishableKey', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getButtonConfig()
    {
        ...
        if (!$pluginInfo) {
            return parent::getButtonConfig();
        } else {
            return $this->___callPlugins('getButtonConfig', func_get_args(), $pluginInfo);
        }
    }
